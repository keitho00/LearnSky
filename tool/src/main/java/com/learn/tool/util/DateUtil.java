...
import static com.learn.tool.entity.DataFormatEnum.PATTERN_CLASSICAL;
...
public class DateUtil {
     ...
     * @return 返回解析后的日期
     */
    public static Date parse(String str, DataFormatEnum pattern) {
        SimpleDateFormat sdf = new SimpleDateFormat(pattern.getFormat());
        try {
     ...
     * @return 返回格式化后的字符串
     */
    public static String format(Date date, DataFormatEnum pattern) {
        SimpleDateFormat sdf = new SimpleDateFormat(pattern.getFormat());
